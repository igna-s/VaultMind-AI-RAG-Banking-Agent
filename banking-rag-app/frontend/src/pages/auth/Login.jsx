...
export default function Login() {
  ...
  const { signInWithGoogle, registerUser, user } = useAuth();
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <motion.div 
        layout
        className="relative z-10 glass-panel p-8 rounded-3xl w-full max-w-md mx-4 text-center"
      >
        <div className="mb-8">
        ...
        <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-[#1e1b2e] text-white/40">or continue with</span>
            </div>
        </div>
